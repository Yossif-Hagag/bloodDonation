                    ...
                    <td width="100%" >
                        <center>
                              <div style="margin:15px 0 0 0">
                                  <h1 style="color: white">Edit Admin</h1>
                                  @if($errors->count() > 0)
                                    <ul class="m-2">
                                  ...
                                  @endif
                                  <hr>
                                  <form method ="POST" action="{{ route('saveAdmin', $admin->id) }}" enctype="multipart/form-data">
                                  @csrf
                                      <input class="inputBlue" type="text" id="name" name="name" placeholder=" Name" required  value = "{{$admin->name}}">
                                      <input class="inputBlue" type="email" id="email" name="email" placeholder="Email" required value = "{{$admin->email}}">
                                      <input class="inputBlue" type="password" id="pass" name="password" placeholder="Password" required >
                                      <input class="inputBlue" type="password" id="cpass" name="password_confirmation" placeholder="Confirm Password" required  autocomplete="new-password">
                                      <input class="inputBlue" type="text" id="phone" name="phone" placeholder=" Phone" required value = "{{$admin->phone}}"><br>
                                     ...
                                     <input type="submit" class="btnBlue" onclick="check()" value="Update">
