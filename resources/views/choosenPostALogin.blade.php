...
<div class="container">
    <div class="row">
        ...
        @if(!$post)
          <div class="post card mt-5 h6">
            <div class="card-body" style="background-color:rgba(0, 0, 0, 0);color: #000;">
              Sorry, you can't donate on this post because you are already donate it before Or post not Found ! 
              <a href="{{ url('/donorProfile') }}" style="text-decoration-line: underline;color: #fff;">Exit</a>
            </div>
          </div>
        @else
          <div class="post">
           @foreach ($hospitals as $hospital)
              @if($post->hospital_id == $hospital->id && $post->hospital_id != NULL)
                  ...
                  <div class="header__left">
                    ...
                    <div class="post__author author">
                      <span class="author__name">
                        <a class="mlink" href="{{ url('/choosenHosprofile', $hospital->id) }}" style="color: #000;"><h1>{{$hospital->name}}</h1></a>
                      </span>
                ...
                <div class="post__content content">
                  <p class="content__paragraph" style="color:#fff;">
