                    ...
                    <td width="100%" >
                        <center>
                              <div style="margin:15px 0 0 0">
                                  ...
                                  @endif
                                  <hr>
                                  <form method ="POST" action="{{url('storeHospital')}}" enctype="multipart/form-data">  
                                  @csrf
                                      <input class="inputBlue" type="text" id="email" name="name" placeholder="Hospital name" required>
                                      <input class="inputBlue" type="text" id="email" name="adress" placeholder="Hospital addresss" required>
                                      <input class="inputBlue" type="text" id="email" name="type" placeholder="Hospital type" required>
                                      <input class="inputBlue" type="email" id="email" name="email" placeholder="Hospital email" required>
                                      <input class="inputBlue" type="password" id="password" name="password" placeholder="password" required><br>
