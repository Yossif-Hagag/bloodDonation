...
<style>
    body  {
        background-image: url("{{asset('images/loginNew.png')}}");
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="background-color:rgba(237,125,44,0.8);color:#fff;">{{ __('Update User') }}</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('saveUser', $user->id) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="birth_date" type="number" min='0' step="1" class="form-control @error('birth_date"') is-invalid @enderror" name="birth_date" value="{{ $user->birth_date }}" required autocomplete="birth_date" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" min='0' step="1" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ $user->phone }}" required autocomplete="phone" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="exampleInputEmail1" class="col-md-4 col-form-label text-md-right">  Photo </label> <div class="col-md-6">
