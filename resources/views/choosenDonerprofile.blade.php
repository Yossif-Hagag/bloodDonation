                ...
                <div class="row">       
                    <div class="col-md-10 ml-5 d-flex justify-content-around">
                        <div class="card mb-5 ml-5">
                            ...
                            @if($user->photo)
                                <img class="card-img-top" src="{{asset('images/donors/' . $user->photo)}}"/>
                            @else
                            ...
                            <div class="card-body d-flex flex-column justify-content-between">
                                <div><span style="font-size: 16px;font-weight:bold;">E-mail : </span>{{ $user->email }}</div>
                                <div><span style="font-size: 16px;font-weight:bold;">Phone Number : </span>{{ $user->phone }}</div>
                                <div><span style="font-size: 16px;font-weight:bold;">Address : </span>{{ $user->address }}</div>
                                <div><span style="font-size: 16px;font-weight:bold;">Age : </span>{{ $user->birth_date }}</div>
                                @foreach ($bloods as $blood)
                                    @if($blood->id == $user->blood_id)
                                        <div><span style="font-size: 16px;font-weight:bold;">Blood Type : </span>{{ $blood->bloodtype }}</div>
                                    @endif
                               @endforeach
                            </div>
                        </div>
